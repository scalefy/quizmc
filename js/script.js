...
continue_btn.onclick = ()=>{
    ...
    showQuetions(0); //calling(chamando) showQestions function
...
next_btn.onclick = ()=>{
    if(que_count < questions.length - 1){ //if question count is less than total question length
        ...
        clearInterval(counter); //clear(limpar) counter
        clearInterval(counterLine); //clear counterLine
...
function showQuetions(index){
    ...
    //adicionando nova tag span dentro de que_tag
    que_text.innerHTML = que_tag; 

    //adding new div tag inside option_tag
    //adicionando nova tag div dentro de option_tag
